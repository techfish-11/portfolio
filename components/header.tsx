...
export default function Header() {
  return (
    <motion.div 
      className="flex items-center gap-3 h-16 px-4 m-4 rounded-full shadow-lg bg-gradient-to-r from-blue-500 to-purple-600 backdrop-blur-sm bg-opacity-50 border border-white"
